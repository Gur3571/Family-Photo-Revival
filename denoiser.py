...
noisy_data=[]
path1 = r"C:\Users\kaurg\Downloads\denoising-dirty-documents\train\train"
...
clean_data=[]
path2 = r"C:\Users\kaurg\Downloads\denoising-dirty-documents\train_cleaned\train_cleaned"
...
model.fit(x_train, y_train, epochs=50, batch_size=8, shuffle=True, verbose = 1,
